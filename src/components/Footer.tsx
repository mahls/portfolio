...
export const Footer = ({dark}: {dark: boolean}) => {
    return(
        ...
        whileTap={{scale: 0.95}}
        className={`flex  items-center align-center h-24 px-5 sm:px-5 ${dark ? "bg-stone-900" : "bg-stone-100"}  md:fixed md:bottom-0 md:right-0 sm:left-0 mt-10 mx-5 sm:mx-10 mb-20  rounded-lg`}>
